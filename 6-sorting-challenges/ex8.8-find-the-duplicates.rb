...
list3 = [10, 3, 17, 11, 5, 10, 3, 9, 11, 33, 41, 22, 8, 17, 3, 11, 35, 52, 73, 88]
list4 = [22, 3, 10, 11, 33, 41, 11, 5, 3, 17, 10, 3, 9, 11, 52, 73, 88, 35, 10, 11, 3, 8, 17, 8]


Benchmark.ips do |x|
  x.config(:time => 3, :warmup => 2)
  
  x.report("Kelvin's Method") {duplicates(list3, list4)}
  x.report("Yunus's Method") {duplicates_y(list3, list4)}
  x.report("Ebuka's Method") {duplicates_e(list3, list4)}
